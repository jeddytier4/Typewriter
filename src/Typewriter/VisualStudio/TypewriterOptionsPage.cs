...
namespace Typewriter.VisualStudio
{
    public class TypewriterOptionsPage : DialogPage
    {
        ...
        [Description("If set to True, Typewriter will track changes to the C# source files in the solution and auto-render matching TypeScript Templates (.tst/.tstx).")]
        [DefaultValue(true)]
        public bool TrackSourceFiles { get; set; } = true;

        [Category("Rendering")]
        [DisplayName("Render template on save")]
        [Description("If set to True, TypeScript Templates (.tst/.tstx) will be re-rendered when saved.")]
        [DefaultValue(true)]
